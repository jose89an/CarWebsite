		 ...
		 if(formulario.telefono.value.length==0){
			 ...
			 if (!formulario.telefono.value.match(tipotelefono)){
				 ...
				 return false;
		 		 ...
		 		 mensaje="¿Acepta registrarse en este servicio de subasta de vehículos aun sabiendo que no poseemos ni política ";
				 mensaje=mensaje+"de protección de datos ni condiciones generales del servicio?";
